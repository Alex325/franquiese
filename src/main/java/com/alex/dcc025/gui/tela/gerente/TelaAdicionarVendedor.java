 ...
 * @author SUPERVISOR
 */
public class TelaAdicionarVendedor extends javax.swing.JPanel {
     ...
     */
    public TelaAdicionarVendedor(Sistema sistema, Gerente usuario, GUI janela) {
    ...
    private void initComponents() {
        ...
        adicionarFranquiaLabel.setText("Adicionar Vendedor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            usuario.cadastrarVendedor(nomeField.getText().trim(), cpfField.getText().trim(), emailField.getText().trim(), new String(senhaField.getPassword()), this.sistema);
        } catch (Exception e) {
